...
* In the Page Text section, "Here are some photos of their journey!" was updated to ""Here are some photos of their epic journey inside the store!" so that it matches the sample webpage
* An extra tip was added to advise that the title of the webpage is be "Amazon Go"
