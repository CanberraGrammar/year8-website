...
*Weight:* 40% +
*Due:* Tuesday 2 June 2020 (Week 16) by 8:45am
...
* *UPDATE 20 MAY:* The due date has been extended to *8:45am on Tuesday 2 June 2020*. This provides you with a bit more time to complete the task, as some students were finding it challenging particularly because they have had limited face-to-face class time with their teacher.
...
Once you have formed into a team contact your teacher via email so we can record your team members. *This must be done by the end of Term 1 (Thursday 9 April 2020).*
