...
This assignment was last updated on *Monday 17 April 2021*.

* *UPDATED 17 May 2021*: Added a modified version of the Marking Criteria for students working individually.

* *UPDATED 1 April 2021*: Updated Marking Criteria for further clarification and allocation of marks.
...
link:marking-guidelines-solo.pdf[Here is a modified version of the marking guidelines if you are working on your own.^]
