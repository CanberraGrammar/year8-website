...
# currently in /home/travis/build/CanberraGrammar/year8-website

# build site with jekyll, by default to `_site' folder
bundle exec jekyll build

# cleanup
rm -rf ../year8.cgscomputing.com

# clone repository into /home/travis/build/CanberraGrammar/year8.cgscomputing.com
git clone https://${GH_TOKEN}@github.com/CanberraGrammar/year8-website.git ../year8.cgscomputing.com

# change to the gh-pages branch
cd ../year8.cgscomputing.com
...
cp -rf _site/* ../year8.cgscomputing.com
