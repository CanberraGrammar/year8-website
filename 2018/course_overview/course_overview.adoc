...
:page-title: Year 8 & 9 IST - Course Overview

= Year 8 & 9 IST

Year 8 and 9 Web App Development is a one year course that forms part of the Information Technology program at Canberra Grammar School. The course is based upon, and complies with, the Information and Software Technology (IST) syllabus from the NSW Education Standards Authority.
