...
This assignment was last updated on *Saturday 30 March 2019*.
...
You may select a partner from a different Year 8 IT class, but your partner must be in Year 8 (even though the Year 9 classes are doing this same assignment you cannot team up with a Year 9 student).
