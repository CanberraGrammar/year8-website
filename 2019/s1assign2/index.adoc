...
*Weight:* 40% +
*Due:* Thursday 23 May 2019 (Week 14) by 8:45am
...
*8 MAY 2019: Groupwork Issues*

A few individuals have expressed concern about the way their groups are working on Assignment Two - so we thought best to post a course-wise announcement regarding this matter.
...
However, in some cases it has been presented that one group member is doing far more work than the other - to the point that the assignment may not be content-compete due to the other member not finishing their half of the assigned work. If you feel like you may be in this situation then please email your teacher explaining the situation in detail. This should only be done if you feel there is a *significant* difference in work contributed - there will always be a slight imbalance in the work allocation, but we need to know if that imbalance is substantial.
...
Once you have formed into a team contact your teacher via email so we can record your team members. *This must be done by the end of Term 1 (Friday 12 April 2019).*
