...
*Weight:* 25% +
*Due:* Monday 23 March 2020 (Week 8) by 8:45am

== Changelog ==

*Monday 2 March 2020:* The sample-page.png screenshot was updated to include a horizontal rule and copyright symbol, as per the marking guidelines.

This assignment was last updated on *Monday 2 March 2020*.
...
* The title of the webpage is "Uber Air"
* The Uber Air image is available from https://raw.githubusercontent.com/CanberraGrammar/year8-website/master/2020/s1assign1/uber.jpg[https://raw.githubusercontent.com/CanberraGrammar/year8-website/master/2020/s1assign1/uber.jpg^]. Do not locally download the uber.jpg file to your ED STEM workspace - source the image from github.com using this address.
